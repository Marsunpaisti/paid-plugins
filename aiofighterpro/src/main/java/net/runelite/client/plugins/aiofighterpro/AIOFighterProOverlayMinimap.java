...
@Slf4j
@Singleton
public class AIOFighterProOverlayMinimap extends Overlay
{
	...
	@Inject
	private AIOFighterProOverlayMinimap(final Client client, final AIOFighterPro plugin, final AIOFighterProConfig config)
	{
		this.client = client;
		this.plugin = plugin;
		this.config = config;
